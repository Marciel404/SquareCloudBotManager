...
const { execute } = require("../../commands/apps");
...
exports.execute = async (interaction) => {
    ...
    try {
        ...
        const status = await RequestsClientSquareCloud.getApplicationStatus(interaction.values[0])
        ...
        await interaction.update({ //Edita a mensagem
        ...
        await execute(interaction) //Atualiza a mensagem caso de erro
